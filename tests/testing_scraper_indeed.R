...
web %>%  html_nodes(xpath = "//*[@id='rb_Salary Estimate']/div/ul/li") %>% html_text() %>% str_trim()

salarys <- data.frame(salary = web %>%  html_nodes(xpath = "//*[@id='rb_Salary Estimate']/div/ul/li") %>% html_text() %>% str_trim())
...
# job type options
web %>% html_nodes(xpath = "//*[@id='rb_Job Type']/div/ul/li") %>% html_text() %>% str_trim()

jobtypes <- data.frame(jt = web %>% html_nodes(xpath = "//*[@id='rb_Job Type']/div/ul/li") %>% html_text() %>% str_trim())
...
# locs options
web %>%  html_nodes(xpath = "//*[@id='rb_Location']/div/ul/li") %>% html_text() %>% str_trim()

locs <- data.frame(locs=web %>%  html_nodes(xpath = "//*[@id='rb_Location']/div/ul/li") %>% html_text() %>% str_trim())
...
# companies options
web %>%  html_nodes(xpath = "//*[@id='rb_Company']/div/ul/li") %>% html_text() %>% str_trim()

comps <- data.frame(comps = web %>%  html_nodes(xpath = "//*[@id='rb_Company']/div/ul/li") %>% html_text() %>% str_trim())
...
web %>%  html_nodes(xpath = "//*[@id='rb_Experience Level']/div/ul/li") %>% html_text() %>% str_trim()

exps <- data.frame(exper = web %>%  html_nodes(xpath = "//*[@id='rb_Experience Level']/div/ul/li") %>% html_text() %>% str_trim())
...
# job title
# web %>%  html_nodes(xpath = "//*[@id='  row  result']/div/h2") %>% html_text() %>% str_trim()
...
# # companies name
# web %>%  html_nodes(xpath = "//*[@id='resultsCol']/div/span") %>% html_text() %>% str_trim() %>% str_trim()

# company
# web %>%  html_nodes(xpath = "//*[@class='  row  result']/span") %>% html_text() %>% str_trim()%>% str_trim()
